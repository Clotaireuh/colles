...
export const state = { students: [], sheets: [], notes: [], theme: 'light' };
...
export const save = () => { clearTimeout(timer); timer = setTimeout(flush, 300); }; // autosave

// Images stockées à part (dataURL) pour ne pas alourdir l'état
export const putImg = (id, data) => tx('img', 'readwrite', o => o.put(data, id));
