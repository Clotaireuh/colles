...
function render() {
  ...
  $('#main').innerHTML = { sheets: vSheets, sheet: vSheet, students: vStudents, notes: vNotes, global: vGlobal }[view]();
...
$('#imp').onchange = async e => {
  try { await S.importAll(JSON.parse(await e.target.files[0].text())); document.documentElement.dataset.theme = S.state.theme; view = 'sheets'; render(); alert('Import réussi.'); }
